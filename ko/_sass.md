...
저 자신은 CSS와 더 비슷하고 대부분의 개발자들에게 더 친숙하기 때문에 SCSS를 Sass보다 더 선호합니다. 그런 이유로, SCSS가 이 가이드라인의 기본 구문입니다. <span data-toggle="aside" class="link-like" role="button" aria-expanded>옵션 패널</span>에서 Sass의 들여쓰기 구문으로 바꾸실 수 있습니다.
