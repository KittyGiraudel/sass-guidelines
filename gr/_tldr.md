...
* Τα κενά διαστήματα είναι δωρεάν, χρησιμοποίησέ τα για να διαχωρίσεις αντικείμενα, κανόνες και ορίσματα. Μη διστάσεις να αφήσεις κενές γραμμές, δε βλάπτει ποτέ. [↩](#syntax--formatting)
...
* Η CSS είναι ζόρικη γλώσσα· μη διαστάσις να γράψεις εκτενέστατα σχόλια για οτιδήποτε φαίνεται (ή είναι) ύποπτο. [↩](#commenting)
