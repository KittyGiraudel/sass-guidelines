...
Благодаря предоставленным в Sass комплексным структурам данных, таких, как [списки](#lists) и [карты](#maps), не удивляет и возможность перебора по этим объектам.
