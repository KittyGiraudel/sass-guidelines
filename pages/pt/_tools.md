...
[Compass](http://compass-style.org/) é o principal [_framework_ Sass](http://www.sitepoint.com/compass-or-bourbon-sass-frameworks/) por aí. Desenvolvida por [Chris Eppstein](https://twitter.com/chriseppstein), um dos designers principais do Sass, não a vejo a perder popularidade drasticamente durante uns tempos, se querem a minha opinião.
