...
Entre outras coisas, Sass é um pré-processador. O seu principal rival será [Less](http://lesscss.org/), um pré-processador baseado em NodeJS que se tornou bastante popular graças à *framework* de CSS [Bootstrap](http://getbootstrap.com/), que fez uso até a versão 4. Existe ainda o [Stylus](http://learnboost.github.io/stylus/), um pré-processador bem flexível e permissivo, apesar de ser um pouquinho mais difícil de usar e com uma comunidade menor.
