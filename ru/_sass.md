...
Кроме препроцессоров, стоит также упомянуть постпроцессоры, которые получили значительное внимание в течение последних нескольких месяцев, главным образом благодаря [PostCSS](https://github.com/postcss/postcss) и [cssnext](HTTPS://cssnext.github.io/). Постпроцессоры во многом довольно похожи на препроцессоры, но они не дают иных возможностей, кроме расширения синтаксиса CSS.
